...
# --tau1 1e-4 \
# --weight_decay 0.01 \
# --out_dir Multi-scale/out_r2bert_topk_k${K} \
# --amp
...
# [Overall] Average QWK across prompts (mean of prompt means): 0.7764


# for K in 5 10 20; do
#   python Multi-scale/r2bert_topkpool_cv.py \
#     --asap_path Multi-scale/asap-aes/training_set_rel3.tsv \
#     --prompt_id 0 \
#     --cv_folds 5 \
#     --num_epochs 60 \
...
#   --tau1 1e-3 \
#   --weight_decay 0.01 \
#   --out_dir Multi-scale/out_topk_tune_2 \
#   --amp

# [Overall] Average QWK across prompts (mean of prompt means): 0.7712
...
# [Overall] Average QWK across prompts (mean of prompt means): 0.7753
...
# [Overall] Average QWK across prompts (mean of prompt means): 0.7702
...
#   --tau1 1e-4 \
#   --weight_decay 0.01 \
#   --out_dir Multi-scale/out_topk_tune_ep70 \
#   --amp

#[Overall] Average QWK across prompts (mean of prompt means): 0.7732